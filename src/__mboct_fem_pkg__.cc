...
public:
     ...
     static void AllocIntegrationRule(FemMatrixType eMatType) {
          ...
          static constexpr double ri1[N1] = { c,  e,  d,  d,  d,  a,  a,  a,  b,  b,  b};
          static constexpr double si1[N1] = { c,  d,  e,  d,  d,  a,  b,  b,  a,  a,  b};
          static constexpr double ti1[N1] = { c,  d,  d,  e,  d,  b,  a,  b,  a,  b,  a};
          ...
          static constexpr octave_idx_type N[] = {N1, N2, N3};
          static constexpr const double* r[] = {ri1, ri2, ri3};
          static constexpr const double* s[] = {si1, si2, si3};          
          static constexpr const double* t[] = {ti1, ti2, ti3};
          static constexpr const double* w[] = {wi1, wi2, wi3};
