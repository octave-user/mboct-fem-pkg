...
private:
		...
		Hs.xelem(8) = ((1-r2)*(s+1)*(t+1))/4.0E+0;
		Hs.xelem(9) = ((1-r)*(1-s2)*(t+1))/4.0E+0;
		Hs.xelem(10) = ((1-r2)*(1-s)*(t+1))/4.0E+0;
		Hs.xelem(11) = ((r+1)*(1-s2)*(t+1))/4.0E+0;
		Hs.xelem(12) = ((1-r2)*(s+1)*(1-t))/4.0E+0;
		Hs.xelem(13) = ((1-r)*(1-s2)*(1-t))/4.0E+0;
		Hs.xelem(14) = ((1-r2)*(1-s)*(1-t))/4.0E+0;
		Hs.xelem(15) = ((r+1)*(1-s2)*(1-t))/4.0E+0;
		Hs.xelem(16) = ((r+1)*(s+1)*(1-t2))/4.0E+0;
		Hs.xelem(17) = ((1-r)*(s+1)*(1-t2))/4.0E+0;
		Hs.xelem(18) = ((1-r)*(1-s)*(1-t2))/4.0E+0;
		Hs.xelem(19) = ((r+1)*(1-s)*(1-t2))/4.0E+0;		
        }
};
