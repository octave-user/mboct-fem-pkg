## fem_pre_mesh_import.m:148
%!test
%! try
%! ## TEST 148 - 2D wave equation
%! ####################################################
%! ## Jont Allen
...
%!   sol.Phi = real(Phi(dof_map.ndof, :) * exp(1j * omega * sol.t));
%!   sol.PhiP = real(1j * omega * Phi(dof_map.ndof, :) * exp(1j * omega * sol.t));
%!   [sol.acoustics] = fem_ass_matrix(mesh, ...
%!                                    dof_map, ...
