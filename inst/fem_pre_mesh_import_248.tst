...
%!   elem_idx_v1 = mesh.groups.penta15(grp_idx_v1).elements;
...
%!   mesh.elements.perfectly_matched_layers.penta15.e1(1, :, :) = mesh.nodes(:, 1)(mesh.elements.penta15.');
%!   mesh.elements.perfectly_matched_layers.penta15.e1(2, :, :) = mesh.nodes(:, 2)(mesh.elements.penta15.');
%!   mesh.elements.perfectly_matched_layers.penta15.e2(3, :, :) = 1;
%!   for i=1:3
%!     mesh.elements.perfectly_matched_layers.penta15.f(i, :, :) = 1;
%!   endfor
%!   x = mesh.nodes(:, 1)(mesh.elements.penta15(elem_idx_v2, :).');
%!   y = mesh.nodes(:, 2)(mesh.elements.penta15(elem_idx_v2, :).');
%!   dr = sqrt(x.^2 + y.^2) - r2;
%!   #####################################################################
...
%!   mesh.elements.perfectly_matched_layers.penta15.f(1, :, elem_idx_v2) = 1 ./ (1 - 1j * sigmax / k);
