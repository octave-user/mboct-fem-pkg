...
%!   load_case.pressure.quad8.p = p / 2 * (yp / b + zp / c);
...
%!   assert_simple(sum(sum(mat_ass.surface.quad8)), b * c, eps^0.9 * b * c);
...
%!     opts_plot.elem_types = {"quad8", "penta15"};
%!     opts_plot.elem_groups.quad8 = [mesh.groups.quad8.id];
%!     opts_plot.elem_groups.penta15 = [mesh.groups.penta15.id];
