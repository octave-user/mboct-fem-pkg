...
%!   grp_id_clamp_y = find([[mesh.groups.quad8r].id] == 2);
%!   grp_id_clamp_x = find([[mesh.groups.quad8r].id] == 3);
%!   grp_id_clamp_z = find([[mesh.groups.quad8r].id] == 4);
%!   grp_id_Pi = find([mesh.groups.quad8r.id] == 5);
%!   grp_id_sigmaz = find([mesh.groups.quad8r.id] == 6);
...
%!   elem_Pi = mesh.elements.quad8r(mesh.groups.quad8r(grp_id_Pi).elements, :);
%!   elem_sigmaz = mesh.elements.quad8r(mesh.groups.quad8r(grp_id_sigmaz).elements, :);
%!   load_case.pressure.quad8r.elements = [elem_Pi; elem_sigmaz];
%!   load_case.pressure.quad8r.p = [repmat(Pi, size(elem_Pi)); repmat(-sigmaz, size(elem_sigmaz))];
