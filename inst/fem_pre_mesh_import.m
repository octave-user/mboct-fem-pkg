    ...
    while (true)
      ...
      switch (line)
        ...
        case "$Elements"
          ...
          eltype = struct("name", {"tet10", "tria6", "tet4", "penta6", "tria3", "iso8", "iso4", "iso20", "quad8", "penta15", "tet10h", "tria6h"}, ...
                          "promote", {-1, -1, 6, 6, 7, -1, -1, -1, -1, -1, -1, -1}, ...
                          "id", {11, 9, 4, 6, 2, 5, 3, 17, 16, 18, 11, 9}, ...
                          "dim", {3, 2, 3, 3, 2, 3, 2, 3, 2, 3, 3, 3}, ...
                          "norder", {[1:8, 10, 9], ...
                                     1:6, ...
                                     [4, 4, 4, 4, 1:3, 3], ...
                                     [6,4,4,5,3,1,1,2], ...
...
%!   load_case.convection.tria6.theta = [repmat(thetae(1), numel(mesh.groups.tria6(1).elements), 6);
%!                                        repmat(thetae(2), numel(mesh.groups.tria6(2).elements), 6)];
%!   dof_map = fem_ass_dof_map(mesh, load_case);
%!   e1 = [1; 0.6; -0.3];
%!   e2 = [-0.5; -0.3; 0.8];
%!   e3 = cross(e1, e2);
