...
%!   grp_idx_wall = find([mesh.groups.quad8r.id] == 3);
...
%!   load_case_dof.locked_dof(mesh.groups.quad8r(grp_idx_wall).nodes) = true;
...
%!   mesh.elements.perfectly_matched_layers.iso20r.f(1, :, elem_idx_volume2) = 1 ./ (1 - 1j * sigmax / k);
%!   [mat_ass.Ka_re, ...
%!    mat_ass.Ka_im, ...
%!    mat_ass.Da_re, ...
%!    mat_ass.Da_im, ...
