...
%!   grp_idx_solid_h = find([mesh.groups.iso20r.id] == 2);
...
%!   mesh.materials.iso20r(mesh.groups.iso20r(grp_idx_fluid_h).elements) = 1;
%!   mesh.materials.iso20r(mesh.groups.iso20r(grp_idx_solid_h).elements) = 2;
%!   if (isfield(mesh.elements, "penta15"))
