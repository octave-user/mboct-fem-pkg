...
%!   endif
%!   [~] = unlink([filename, ".geo"]);
%!   opt_mesh.elem_type = {"tria6h", "quad9", "iso27", "penta18"};
...
%!   grp_idx_conv = find([mesh.groups.quad9.id] == 2);
%!   mesh.elements.convection.quad9.nodes = mesh.elements.quad9([mesh.groups.quad9(grp_idx_conv).elements], :);
...
%!   node_idx_surface = mesh.groups.quad9(grp_idx_conv).nodes;
