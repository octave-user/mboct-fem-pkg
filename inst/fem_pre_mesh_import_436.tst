...
%!   grp_idx_v4 = find([mesh.groups.iso20r.id] == 4);
%!   elem_idx_v2 = mesh.groups.iso20r(grp_idx_v2).elements;
%!   elem_idx_v3 = mesh.groups.iso20r(grp_idx_v3).elements;
%!   elem_idx_v4 = mesh.groups.iso20r(grp_idx_v4).elements;
...
%!   x = mesh.nodes(:, 1);
%!   y = mesh.nodes(:, 2);
%!   dx2 = abs(x(mesh.elements.iso20r(elem_idx_v2, :).')) - 0.5 * l;
%!   dy3 = abs(y(mesh.elements.iso20r(elem_idx_v3, :).')) - 0.5 * w;
%!   dx4 = abs(x(mesh.elements.iso20r(elem_idx_v4, :).')) - 0.5 * l;
%!   dy4 = abs(y(mesh.elements.iso20r(elem_idx_v4, :).')) - 0.5 * w;
%!   #####################################################################
...
%!   mesh.elements.perfectly_matched_layers.iso20r.f(1, :, elem_idx_v2) = 1 ./ (1 - 1j * sigmax2 / k);
%!   mesh.elements.perfectly_matched_layers.iso20r.f(2, :, elem_idx_v3) = 1 ./ (1 - 1j * sigmay3 / k);
%!   mesh.elements.perfectly_matched_layers.iso20r.f(1, :, elem_idx_v4) = 1 ./ (1 - 1j * sigmax4 / k);
%!   mesh.elements.perfectly_matched_layers.iso20r.f(2, :, elem_idx_v4) = 1 ./ (1 - 1j * sigmay4 / k);
