...
%!   mesh.elements.convection.quad9.h = [repmat(h0, size(mesh.elements.quad9(mesh.groups.quad9(1).elements, :)));
%!                                       repmat(h1, size(mesh.elements.quad9(mesh.groups.quad9(2).elements, :)))];
%!   load_case.convection.quad9.theta = [theta_s(mesh.elements.quad9(mesh.groups.quad9(1).elements, :));
%!                                       theta_s(mesh.elements.quad9(mesh.groups.quad9(2).elements, :))];
