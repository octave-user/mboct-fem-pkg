## fem_pre_mesh_import.m:162
%!test
%! try
%! ### TEST 162 - 1D wave equation
%! ####################################################
%! ## Jont Allen
...
%!   node_idx_input = mesh.groups.tria6(grp_idx_input).nodes;
%!   node_idx_output = mesh.groups.tria6(grp_idx_output).nodes;
