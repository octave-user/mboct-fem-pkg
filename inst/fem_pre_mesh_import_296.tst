## fem_pre_mesh_import.m:296
%!test
%! ## TEST 296 - 2D wave equation
%! ####################################################
%! ## Jont Allen
...
%!   no_s1 = mesh.groups.tria10(grp_idx_s1).nodes;
%!   no_s2 = mesh.groups.tria10(grp_idx_s2).nodes;
%!   no_s3 = mesh.groups.tria10(grp_idx_s3).nodes;
