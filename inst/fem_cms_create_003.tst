...
%! mesh.elements.rbe2(1).nodes = int32([13, 9]);
%! mesh.elements.rbe2(2).nodes = int32([13, 10]);
%! mesh.elements.rbe2(3).nodes = int32([13, 11]);
%! mesh.elements.rbe2(4).nodes = int32([13, 12]);
%! mesh.elements.rbe2(5).nodes = int32([14, 2]);
%! mesh.elements.rbe2(6).nodes = int32([14, 3]);
%! mesh.elements.rbe2(7).nodes = int32([14, 6]);
%! mesh.elements.rbe2(8).nodes = int32([14, 7]);
...
%!  sol_eig_cms, ...
%!  cms_opt, ...
%!  sol_tau] = fem_cms_create2(mesh, load_case, cms_opt);
%! if (f_run_post_proc)
%! filename = "";
%! unwind_protect
%!   filename = tempname();
