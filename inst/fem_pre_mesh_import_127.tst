## fem_pre_mesh_import.m:127
%!test
%! ## TEST 127 - 2D wave equation
%! ####################################################
%! ## Jont Allen
...
%!   grp_idx_s4 = find([mesh.groups.tria6h.id] == 4);
%!   elno_s1 = mesh.elements.tria6h(mesh.groups.tria6h(grp_idx_s1).elements, :);
%!   elno_s2 = mesh.elements.tria6h(mesh.groups.tria6h(grp_idx_s2).elements, :);
%!   elno_s3 = mesh.elements.tria6h(mesh.groups.tria6h(grp_idx_s3).elements, :);
%!   elno_s4 = mesh.elements.tria6h(mesh.groups.tria6h(grp_idx_s4).elements, :);
...
%!   mesh.elements.particle_velocity.tria6h.nodes = [elno_s1; elno_s2; elno_s3; elno_s4];
...
%!   load_case(1).particle_velocity.tria6h.vn = real([nv1; nv2; nv3; nv4]);
%!   load_case(2).particle_velocity.tria6h.vn = imag([nv1; nv2; nv3; nv4]);
