## fem_pre_mesh_import.m:228
%!test
%! ## TEST 228 - 1D dissipative wave equation with perfectly matched layers
...
%!   elem_idx_volume2 = mesh.groups.iso20(grp_idx_volume2).elements;
%!   [x, idx] = sort(mesh.nodes(:, 1));
%!   xPML = mesh.nodes(:, 1)(mesh.elements.iso20(elem_idx_volume2, :).') - l1;
...
%!   mesh.elements.perfectly_matched_layers.iso20.f(1, :, elem_idx_volume2) = 1 ./ (1 - 1j * sigmax / k);
%!   [mat_ass.Ka_re, ...
%!    mat_ass.Ka_im, ...
%!    mat_ass.Da_re, ...
%!    mat_ass.Da_im, ...
