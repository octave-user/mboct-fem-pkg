## fem_pre_mesh_import.m:368
%!test
%! ## TEST 368 - 1D dissipative wave equation with perfectly matched layers
%! close all;
%! filename = "";
%! unwind_protect
%!   filename = tempname();
...
%!   mesh.elements.perfectly_matched_layers.iso27.f(1, :, elem_idx_volume2) = 1j * k * (deltaPML - xPML);
%!   [mat_ass.Ka_re, ...
%!    mat_ass.Ka_im, ...
%!    mat_ass.Da_re, ...
%!    mat_ass.Da_im, ...
