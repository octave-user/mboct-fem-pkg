...
%!   mesh.materials.acoustic_boundary.tria10(mesh.groups.tria10(grp_idx_output).elements) = 3;
...
%!   node_idx_input = mesh.groups.tet20(grp_idx_volume1).nodes;
%!   node_idx_output = mesh.groups.tet20(grp_idx_volume3).nodes;
