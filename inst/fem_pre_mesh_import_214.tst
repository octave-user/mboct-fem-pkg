...
%!   grp_idx_v_h_PML_x = find([mesh.groups.iso20.id] == 3);
%!   grp_idx_v_h_PML_y = find([mesh.groups.iso20.id] == 4);
%!   grp_idx_v_h_PML_z = find([mesh.groups.iso20.id] == 5);
...
%!   grp_idx_s_t_boundaryPML = find([mesh.groups.tria6.id] == 4);
...
%!   elem_idx_h_PML_x = mesh.groups.iso20(grp_idx_v_h_PML_x).elements;
%!   elem_idx_h_PML_y = mesh.groups.iso20(grp_idx_v_h_PML_y).elements;
%!   elem_idx_h_PML_z = mesh.groups.iso20(grp_idx_v_h_PML_z).elements;
%!   node_idx_constr = [mesh.groups.quad8(grp_idx_s_q_boundaryPML).nodes, ...
%!                      mesh.groups.tria6(grp_idx_s_t_boundaryPML).nodes];
%!   empty_cell = cell(1, 2);
...
%!   mesh.materials.iso20(mesh.groups.iso20(grp_idx_v_h_PML_x).elements) = 2;
%!   mesh.materials.iso20(mesh.groups.iso20(grp_idx_v_h_PML_y).elements) = 2;
%!   mesh.materials.iso20(mesh.groups.iso20(grp_idx_v_h_PML_z).elements) = 2;
...
%!     xi_h = abs(mesh.nodes(:, 1)(mesh.elements.iso20(elem_idx_h_PML_x, :).')) - (r + b);
%!     yi_h = abs(mesh.nodes(:, 2)(mesh.elements.iso20(elem_idx_h_PML_y, :).')) - (r + b);
%!     zi_h = abs(mesh.nodes(:, 3)(mesh.elements.iso20(elem_idx_h_PML_z, :).')) - (r + b);
...
%!         mesh.elements.perfectly_matched_layers.iso20.f(1, :, elem_idx_h_PML_x) = 1 ./ (1 - 1j * sigmax_h_k / k);
%!         mesh.elements.perfectly_matched_layers.iso20.f(2, :, elem_idx_h_PML_y) = 1 ./ (1 - 1j * sigmay_h_k / k);
%!         mesh.elements.perfectly_matched_layers.iso20.f(3, :, elem_idx_h_PML_z) = 1 ./ (1 - 1j * sigmaz_h_k / k);
%!       endif
%!       [mat_ass.Mfs_re, ...
%!        mat_ass.Mfs_im, ...
%!        mat_ass.Kfs_re, ...
