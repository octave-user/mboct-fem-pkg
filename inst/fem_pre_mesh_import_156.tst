## fem_pre_mesh_import.m:156
%!test
%! try
%! ## TEST 156 - 2D wave equation
%! ####################################################
%! ## Jont Allen
...
%!     fputs(fd, "  Surface{5}; Layers{Ceil(h/dx)}; Recombine;\n");
%!     fputs(fd, "};\n");
...
%!   mesh.elements.acoustic_impedance.iso4.z = repmat(rho * c, size(mesh.elements.acoustic_impedance.iso4.nodes));
