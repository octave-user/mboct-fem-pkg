## fem_pre_mesh_import.m:362
%!test
%! ## TEST 362 - 1D dissipative wave equation with perfectly matched layers
...
%!   mesh.elements.perfectly_matched_layers.iso27.f(1, :, elem_idx_volume2) = 1 ./ (1 - 1j * sigmax / k);
%!   [mat_ass.Ka_re, ...
%!    mat_ass.Ka_im, ...
%!    mat_ass.Da_re, ...
%!    mat_ass.Da_im, ...
