...
%!   mesh_data(3).mesh.materials.iso20r = ones(rows(mesh_data(3).mesh.elements.iso20r), 1, "int32");
...
%!   mesh_data(4).mesh.materials.iso20r = ones(rows(mesh_data(4).mesh.elements.iso20r), 1, "int32");
...
%!   mesh.elements.convection.quad8r.nodes = mesh.elements.quad8r([[mesh.groups.quad8r(grp_idx_convection_tria6)].elements], :);
%!   mesh.elements.convection.quad8r.h = repmat(he, size(mesh.elements.convection.quad8r.nodes));
%!   mesh.elements.sfncon8r(1).master = mesh.elements.quad8r([[mesh.groups.quad8r(grp_idx_weldseam2_master)].elements], :);
%!   mesh.elements.sfncon8r(1).slave = [[mesh.groups.quad8r(grp_idx_weldseam2_slave)].nodes](:);
%!   mesh.elements.sfncon8r(1).maxdist = 1e-6;
%!   mesh.elements.sfncon8r(2).master = mesh.elements.quad8r([[mesh.groups.quad8r(grp_idx_weldseam3_master)].elements], :);
%!   mesh.elements.sfncon8r(2).slave = [[mesh.groups.quad8r(grp_idx_weldseam3_slave)].nodes](:);
%!   mesh.elements.sfncon8r(2).maxdist = 1e-6;
%!   mesh.elements.sfncon8r(3).master = mesh.elements.quad8r([[mesh.groups.quad8r(grp_idx_weldseam4_master)].elements], :);
%!   mesh.elements.sfncon8r(3).slave = [[mesh.groups.quad8r(grp_idx_weldseam4_slave)].nodes](:);
%!   mesh.elements.sfncon8r(3).maxdist = 1e-6;
%!   mesh.elements.sfncon8r(4).master = mesh.elements.quad8r([[mesh.groups.quad8r(grp_idx_weldseam5_master)].elements], :);
%!   mesh.elements.sfncon8r(4).slave = [[mesh.groups.quad8r(grp_idx_weldseam5_slave)].nodes](:);
%!   mesh.elements.sfncon8r(4).maxdist = 1e-6;
