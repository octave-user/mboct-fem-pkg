...
%!   elem_idx_v1 = mesh.groups.iso8(grp_idx_v1).elements;
...
%!   mesh.elements.perfectly_matched_layers.iso8.e1(1, :, :) = mesh.nodes(:, 1)(mesh.elements.iso8.');
%!   mesh.elements.perfectly_matched_layers.iso8.e1(2, :, :) = mesh.nodes(:, 2)(mesh.elements.iso8.');
%!   mesh.elements.perfectly_matched_layers.iso8.e2(3, :, :) = 1;
%!   for i=1:3
%!     mesh.elements.perfectly_matched_layers.iso8.f(i, :, :) = 1;
%!   endfor
%!   x = mesh.nodes(:, 1)(mesh.elements.iso8(elem_idx_v2, :).');
%!   y = mesh.nodes(:, 2)(mesh.elements.iso8(elem_idx_v2, :).');
%!   dr = sqrt(x.^2 + y.^2) - r2;
%!   #####################################################################
