...
%!   [~] = unlink([filename, ".msh"]);
%!   mesh.materials.penta18 = zeros(rows(mesh.elements.penta18), 1, "int32");
%!   grp_id_mat1 = find([mesh.groups.penta18.id] == 1);
%!   grp_id_mat2 = find([mesh.groups.penta18.id] == 2);
%!   for i=1:numel(grp_id_mat1)
%!     mesh.materials.penta18(mesh.groups.penta18(grp_id_mat1(i)).elements(:)) = 1;
%!   endfor
%!   for i=1:numel(grp_id_mat2)
%!     mesh.materials.penta18(mesh.groups.penta18(grp_id_mat2(i)).elements(:)) = 2;
%!   endfor
%!   Ec = 210000e6;
%!   Ei = 125000e6;
%!   CTEc = 12.5e-6;
...
%!   load_case.locked_dof(mesh.groups.quad9(find([[mesh.groups.quad9].id] == 3)).nodes, :) = true;
