## fem_pre_mesh_import.m:168
%!test
%! ### TEST 168 - spherical waves
%! ####################################################
%! ## Jont Allen
...
%!   mesh.elements.particle_velocity.tria6.nodes = mesh.elements.tria6(mesh.groups.tria6(grp_idx_inlet).elements, :);
%!   mesh.materials.particle_velocity.tria6 = ones(rows(mesh.elements.particle_velocity.tria6.nodes), 1, "int32");
%!   xi = mesh.nodes(:, 1)(mesh.elements.particle_velocity.tria6.nodes);
%!   yi = mesh.nodes(:, 2)(mesh.elements.particle_velocity.tria6.nodes);
%!   zi = mesh.nodes(:, 3)(mesh.elements.particle_velocity.tria6.nodes);
...
%!   yo = mesh.nodes(:, 2)(mesh.elements.acoustic_impedance.tria6.nodes);
%!   zo = mesh.nodes(:, 3)(mesh.elements.acoustic_impedance.tria6.nodes);
%!   ro = sqrt(xo.^2 + yo.^2 + zo.^2);
%!   mesh.elements.acoustic_impedance.tria6.z = z(ro);
...
%!   load_case(1).particle_velocity.tria6.vn = real(vn(ri, 0));
%!   load_case(2).particle_velocity.tria6.vn = imag(vn(ri, 0));
