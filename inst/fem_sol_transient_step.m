...
## -*- texinfo -*-
## @deftypefn {Function File} [@var{U_1}, @var{dU_dt_1}, @var{dU_dt2_1}] = fem_sol_transient_init(@var{U_0}, @var{dU_dt_0}, @var{dU_dt2_0}, @var{R_1}, @var{data})
## Perform a time step
##
...
function [U_1, dU_dt_1, dU_dt2_1] = fem_sol_transient_step(U_0, dU_dt_0, dU_dt2_0, R_1, data)
