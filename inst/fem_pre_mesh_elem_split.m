...
%!   mesh(idx_mesh).material_data.E = 210000e6;
%!   mesh(idx_mesh).material_data.nu = 0.3;
%!   mesh(idx_mesh).material_data.rho = rho;
%!   mesh(idx_mesh).material_data.C = fem_pre_mat_isotropic(mesh(idx_mesh).material_data.E, mesh(idx_mesh).material_data.nu);
...
%! mesh_data(1).mesh.material_data.C = fem_pre_mat_isotropic(mesh_data(1).mesh.material_data.E, mesh_data(1).mesh.material_data.nu);
%! options.iso8.max_angle = 95 * pi / 180;
