...
%!   grp_idx_v2_iso20r = find([mesh.groups.iso20r.id] == 2);
%!   grp_idx_v2_penta15 = find([mesh.groups.penta15.id] == 2);
%!   grp_idx_s1_quad8r = find([mesh.groups.quad8r.id] == 1);
%!   grp_idx_s2_quad8r = find([mesh.groups.quad8r.id] == 2);
%!   grp_idx_s3_quad8r = find([mesh.groups.quad8r.id] == 3);
%!   grp_idx_s3_tria6h = find([mesh.groups.tria6h.id] == 3);
%!   grp_idx_s4_quad8r = find([mesh.groups.quad8r.id] == 4);
%!   grp_idx_s4_tria6h = find([mesh.groups.tria6h.id] == 4);
%!   grp_idx_s5_quad8r = find([mesh.groups.quad8r.id] == 5);
%!   grp_idx_s6_quad8r = find([mesh.groups.quad8r.id] == 6);
%!   grp_idx_s6_tria6h = find([mesh.groups.tria6h.id] == 6);
%!   grp_idx_s7_quad8r = find([mesh.groups.quad8r.id] == 7);
%!   grp_idx_s7_tria6h = find([mesh.groups.tria6h.id] == 7);
...
%!   mesh.materials.iso20r(mesh.groups.iso20r(grp_idx_v1_iso20r).elements) = 2;
%!   mesh.materials.penta15(mesh.groups.penta15(grp_idx_v1_penta15).elements) = 2;
%!   mesh.materials.iso20r(mesh.groups.iso20r(grp_idx_v2_iso20r).elements) = 1;
...
%!   elid_fsi_quad8r = [[mesh.groups.quad8r([grp_idx_s3_quad8r, grp_idx_s4_quad8r, grp_idx_s5_quad8r])].elements];
%!   elid_fsi_tria6h = [[mesh.groups.tria6h([grp_idx_s3_tria6h, grp_idx_s4_tria6h])].elements];
%!   noid_sliding_s1 = [mesh.groups.quad8r(grp_idx_s1_quad8r).nodes];
%!   noid_sliding_s2 = [mesh.groups.quad8r(grp_idx_s2_quad8r).nodes];
%!   elid_impe_quad8r = mesh.groups.quad8r(grp_idx_s6_quad8r).elements;
%!   elid_impe_tria6h = mesh.groups.tria6h(grp_idx_s6_tria6h).elements;
%!   elid_vel_quad8r = mesh.groups.quad8r(grp_idx_s7_quad8r).elements;
%!   elid_vel_tria6h = mesh.groups.tria6h(grp_idx_s7_tria6h).elements;
%!   noid_outlet = [mesh.groups.quad8r(grp_idx_s6_quad8r).nodes, mesh.groups.tria6h(grp_idx_s6_tria6h).nodes];
%!   noid_inlet = [mesh.groups.quad8r(grp_idx_s7_quad8r).nodes, mesh.groups.tria6h(grp_idx_s7_tria6h).nodes];
%!   mesh.elements.fluid_struct_interface.quad8r = mesh.elements.quad8r(elid_fsi_quad8r, :);
%!   mesh.elements.fluid_struct_interface.tria6h = mesh.elements.tria6h(elid_fsi_tria6h, :);
...
%!   mesh.elements.acoustic_impedance.quad8r.nodes = mesh.elements.quad8r(elid_impe_quad8r, :);
%!   mesh.elements.acoustic_impedance.quad8r.z = repmat(rho1 * c1, size(mesh.elements.acoustic_impedance.quad8r.nodes));
%!   mesh.materials.acoustic_impedance.quad8r = ones(rows(mesh.elements.acoustic_impedance.quad8r.nodes), 1, "int32");
%!   mesh.elements.acoustic_impedance.tria6h.nodes = mesh.elements.tria6h(elid_impe_tria6h, :);
%!   mesh.elements.acoustic_impedance.tria6h.z = repmat(rho1 * c1, size(mesh.elements.acoustic_impedance.tria6h.nodes));
%!   mesh.materials.acoustic_impedance.tria6h = ones(rows(mesh.elements.acoustic_impedance.tria6h.nodes), 1, "int32");
%!   mesh.elements.particle_velocity.quad8r.nodes = mesh.elements.quad8r(elid_vel_quad8r, :);
%!   mesh.materials.particle_velocity.quad8r = ones(rows(mesh.elements.particle_velocity.quad8r.nodes), 1, "int32");
%!   load_case(1).particle_velocity.quad8r.vn = repmat(-real(vz), size(mesh.elements.particle_velocity.quad8r.nodes));
%!   load_case(2).particle_velocity.quad8r.vn = repmat(-imag(vz), size(mesh.elements.particle_velocity.quad8r.nodes));
%!   mesh.elements.particle_velocity.tria6h.nodes = mesh.elements.tria6h(elid_vel_tria6h, :);
%!   mesh.materials.particle_velocity.tria6h = ones(rows(mesh.elements.particle_velocity.tria6h.nodes), 1, "int32");
%!   load_case(1).particle_velocity.tria6h.vn = repmat(-real(vz), size(mesh.elements.particle_velocity.tria6h.nodes));
%!   load_case(2).particle_velocity.tria6h.vn = repmat(-imag(vz), size(mesh.elements.particle_velocity.tria6h.nodes));
%!   mesh.elements.acoustic_boundary.quad8r = mesh.elements.quad8r([[mesh.groups.quad8r([grp_idx_s6_quad8r, grp_idx_s7_quad8r])].elements], :);
%!   mesh.materials.acoustic_boundary.quad8r = ones(rows(mesh.elements.acoustic_boundary.quad8r), 1, "int32");
%!   mesh.elements.acoustic_boundary.tria6h = mesh.elements.tria6h([[mesh.groups.tria6h([grp_idx_s6_tria6h, grp_idx_s7_tria6h])].elements], :);
...
%!                                                load_case, ...
%!                                                sol);
%!     P(i) = sum(sol.acoustic_intensity.P.quad8r) + sum(sol.acoustic_intensity.P.tria6h);
%!     if (do_plot)
