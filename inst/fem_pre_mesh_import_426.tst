...
%!   noid_outlet = [mesh.groups.quad8(grp_idx_s6_quad8).nodes, mesh.groups.tria6h(grp_idx_s6_tria6h).nodes];
%!   noid_inlet = [mesh.groups.quad8(grp_idx_s7_quad8).nodes, mesh.groups.tria6h(grp_idx_s7_tria6h).nodes];
...
%!                                                load_case, ...
%!                                                sol);
%!     P(i) = sum(sol.acoustic_intensity.P.quad8) + sum(sol.acoustic_intensity.P.tria6h);
%!     if (do_plot)
