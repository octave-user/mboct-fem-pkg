...
%!   endif
%!   if (isfield(mesh_data(1).mesh.elements, "iso27"))
...
%!   endif
%!   if (isfield(mesh_data(2).mesh.elements, "iso27"))
...
%!   group_idx_theta = find([[mesh.groups.quad9].id] == 1);
%!   group_idx_master = find([[mesh.groups.quad9].id] == 2);
%!   group_idx_slave = find([[mesh.groups.quad9].id] == 3);
%!   nodes_constr = unique([[mesh.groups.quad9(group_idx_theta)].nodes]);
%!   elem_constr.sfncon9.master = mesh.elements.quad9(mesh.groups.quad9(group_idx_master).elements, :);
%!   elem_constr.sfncon9.slave = mesh.groups.quad9(group_idx_slave).nodes(:);
%!   elem_constr.sfncon9.maxdist = 1e-4 * a;
...
%!   for i=1:numel(elem_constr.sfncon9.slave)
%!     idx = find(nodes_constr == elem_constr.sfncon9.slave(i));
%!     nodes_constr(idx) = -1;
%!   endfor
