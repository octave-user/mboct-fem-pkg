## fem_pre_mesh_import.m:129
%!test
%! ## TEST 129 - 2D wave equation
%! ####################################################
%! ## Jont Allen
...
%!   mesh.elements.particle_velocity.quad8.nodes = [elno_s2; elno_s4];
...
%!   load_case(1).particle_velocity.quad8.vn = real([nv2; nv4]);
%!   load_case(2).particle_velocity.quad8.vn = imag([nv2; nv4]);
