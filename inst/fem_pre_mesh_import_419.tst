...
%!   mesh.materials.acoustic_boundary.quad8r(mesh.groups.quad8r(grp_idx_output).elements) = 3;
...
%!   node_idx_input = mesh.groups.iso20r(grp_idx_volume1).nodes;
%!   node_idx_output = mesh.groups.iso20r(grp_idx_volume3).nodes;
